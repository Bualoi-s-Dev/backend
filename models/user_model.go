...
type User struct {
	...
	ShowcasePackages []primitive.ObjectID  `bson:"showcase_packages,omitempty" json:"showcasePackages"`
	Packages      []primitive.ObjectID  `bson:"photographer_packages,omitempty" json:"packages"`
}
