...
type AppointmentResponse struct {
	...
	CustomerID     string `bson:"user_id" json:"customer_id" example:"656e2b5e3f1a3c4d8b9e5678"`
	PhotographerID string `bson:"photographer_id" json:"photographer_id" example:"656e2b5e3f1a3c4d8b9e91011"`
	PackageID      string `bson:"package_id" json:"package_id" example:"656e2b5e3f1a3c4d8b9e6969"`
	SubPackageID   string `bson:"sub_package_id" json:"sub_package_id" example:"656e2b5e3f1a3c4d8b9e4205"`
